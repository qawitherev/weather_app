...
class SearchedWind extends StatelessWidget {
  const SearchedWind({Key? key}) : super(key: key);
          ...
          child: Row(
            ...
            children: [
              _columnBuilder(
                  ...
                  header: 'Wind Speed',
                  data: '${weatherData.weatherSearched.windSpeed.toStringAsFixed(2)} m/s'),
              const SizedBox(
                width: 20,
              ),
              _columnBuilder(
                  ...
                  data: WindDirection.windDirection(weatherData.weatherSearched.windAngle))
            ],
          ),
        ),
      ),
